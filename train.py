...
def train(data_file,kinds):
    ...
    tf.flags.DEFINE_string("max_data_length", 6000, "The max length of data.")
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(
                os.path.join(os.path.curdir, "runs_" + data_file.split('/')[2], categoryName))
            return_dir = os.path.join(os.path.curdir, "runs_" + data_file.split('/')[2])
            print("Writing to {}\n".format(out_dir))
            ...
            return tp, fp, tn, fn, return_dir

if __name__ == '__main__':
    tp, fp, tn, fn, return_dir = train('./path/path_bitcoin/dev.txt',0)
